...
- **結構化資料**：595 張卡牌條目（xlsm 卡表）＋擴充獵人牌組補充＋23 條魔物總表（元素、地形、特殊規則、遠征設置，皆附出處）
- **誠實性防線**：低相關性檢索自動示警、資料庫外內容明確聲明、「未收錄／依版面推測」標記如實轉述

## 資料夾結構

```
├── 規則書/       官方規則書＋擴充＋FAQ PDF（不隨儲存庫散布，請自備）
...
- **戰役書（Campaign Book）與魔物行為卡全文不在資料庫**——助手會在相關問題中主動說明；行為卡資訊靠頁面截圖＋視覺模型補足
